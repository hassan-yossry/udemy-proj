...
describe('this is a test for helper for validateImageName', () => {
  ...
  it('Throws error for an invalid name', () => {
    expect(() => validateImageName('noimagevcanhavethisname')).toThrowError(
...
describe('this is a test for helper for validateHeightWidth', () => {
  ...
  it('height is numerical', () => {
    expect(() => validateHeightWidth('nn', '100')).toThrowError(
      'Height and width must be numbers'
    );
  });
  it('width is numerical', () => {
    expect(() => validateHeightWidth('200', 'cc')).toThrowError(
      'Height and width must be numbers'
    );
  });
  it('height is greater than zero', () => {
    expect(() => validateHeightWidth('-2', '100')).toThrowError(
      'Enter a height and width value greater than zero'
    );
  });
  it('width is greater than zero', () => {
    expect(() => validateHeightWidth('3', '0')).toThrowError(
      'Enter a height and width value greater than zero'
    );
  });
});
